...
class MyAdapter(private val noteList: MutableList<String>,private val noteListSelected: MutableList<Boolean>,private var context: Context) : RecyclerView.Adapter<MyAdapter.MyViewHolder>() {

    // Provide a reference to the views for each data item
    // Complex data items may need more than one view per item, and
    // you provide access to all the views for a data item in a view holder.
    // Each data item is just a string in this case that is shown in a TextView.
    class MyViewHolder(v: View, context: Context,val noteListSelected: MutableList<Boolean>) : RecyclerView.ViewHolder(v) {
        ...
        init {
            ...
            v.notebutton.setOnClickListener {
                ...
                builder.setView(input)
                    builder.setPositiveButton("Finish") { _, _ -> v.notebutton.text = input.text.toString()  }
            ...
            v.noteimage.setOnClickListener {
                if(pinState){
                    ...
                    pinState = false
                    noteListSelected[positionHolder] = pinState
                    context
                } else {
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
        ...
        return MyViewHolder(v,context,noteListSelected)
    }
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.textDisplay.text = noteList[position]
    ...
    fun getSelected(): MutableList<Boolean> {
        return noteListSelected;
    }
